			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="view-order.php">Order</a></li>
	...
	<div class="about-section-box">
		<div class="container">
			<div class="row" align="center">
				<div id="vf">
				<h1 id="vfh1" align="center"> View Order form</h1><br>
       <table  style="border-color:#d0a772;border-style: dotted;margin-left:100px;" width="1000px" align="left" >
					
					<tr align="center"><th width="100px" height="100px">ID:</th>					
						<th width="150px" height="50px">Product NO:</th>
						...
						<th width="150px" height="50px">Order No:</th>						
					 </tr>	
					 <?php
					 error_reporting(1);
