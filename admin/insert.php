...
if($result)			
  ...
  // move_uploaded_file($_FILES['file']['tmp_name'],"itempics/$itemno.jpg");
	    ...
	    $err="<font color='#d0a772' size='+2'>item inserted successfully</font>";
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="insert.php">Insert</a></li>
	...
	<div class="about-section-box">
		<div class="container">
			<div class="row">
                ...
                <h2 id="adminh3" align="center">Insert Image</h2><br>
                
				<form  name="testform" method="post" enctype="multipart/form-data" >
			<table style="border-color:#d0a772; border-style: dotted; margin-left:50px;" width="600px" align="center">
