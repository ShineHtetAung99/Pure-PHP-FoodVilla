	...
	<div class="about-section-box">
		<div class="container">
			<div class="row">
				...
				<h1 id="vmh1" align="center"> View Menu </h1>
    			<br>
        ...
        <?php
					 ...
					 include("connection.php");
						...
						echo"<form method='post'><table style='border-color:#d0a772;border-style: dotted;margin-left:150px;' width='800px' align='left' ><tr><td>Image:</td><td>Product No:</td><td>Price:</td></tr>";
   $n=0;
